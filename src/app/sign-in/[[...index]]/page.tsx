    ...
    <div className="min-h-screen flex items-center justify-center bg-[#020617] p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 space-y-2">
          ...
          <h1 className="text-3xl font-bold text-slate-50">เข้าสู่ระบบร้าน Sakura</h1>
          <p className="text-slate-300 text-base">จัดการแคมเปญ โฆษณา และสต็อกได้ในที่เดียว</p>
        </div>
