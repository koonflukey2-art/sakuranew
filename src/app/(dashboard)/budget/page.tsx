...
const mockBudgets = [
  { id: "1", purpose: "โฆษณา Facebook", amount: 50000, spent: 32500, startDate: "2024-06-01", endDate: "2024-06-30" },
  { id: "2", purpose: "โฆษณา TikTok", amount: 30000, spent: 18000, startDate: "2024-06-01", endDate: "2024-06-30" },
  { id: "3", purpose: "โฆษณา Shopee", amount: 20000, spent: 12000, startDate: "2024-06-01", endDate: "2024-06-30" },
  { id: "4", purpose: "สต็อกสินค้า", amount: 100000, spent: 75000, startDate: "2024-06-01", endDate: "2024-06-30" },
  { id: "5", purpose: "ค่าดำเนินการ", amount: 15000, spent: 8500, startDate: "2024-06-01", endDate: "2024-06-30" },
];
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-500">฿{weeklyRevenue.toLocaleString()}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-500">฿{weeklyProfit.toLocaleString()}</div>
          </CardContent>
        </Card>
      </div>
