    ...
    <div className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-2">
                ...
                <ul className="space-y-1 text-sm text-yellow-100/90">
                  {lowStockCount > 0 && (
                    <li>
                      • มีสินค้า {lowStockCount} รายการที่ต่ำกว่าระดับสต็อกขั้นต่ำ
                    </li>
                  )}
                  {budget && remainingBudget <= 0 && (
                    <li>• งบประมาณหมดแล้ว - โปรดเติมงบ</li>
                  )}
                  {budget &&
                    remainingBudget > 0 &&
                    remainingBudget <= (budget.minThreshold ?? 0) && (
                      <li>
                        ...
                        {formatCurrency(budget.minThreshold ?? 0)})
                      </li>
                    )}
                </ul>
              </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <Card className="premium-card">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-xl">
              <Activity className="w-5 h-5 text-purple-400" /> ยอดขายตามประเภท
              (วันนี้)
            </CardTitle>
                  ...
                  >
                    <div>
                      ...
                      <p className="text-xs text-gray-400">
                        {order.customer?.name || "ลูกค้าไม่ระบุ"} •{" "}
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  จากงบทั้งหมด {formatCurrency(totalBudget)}
                </p>
              </div>
