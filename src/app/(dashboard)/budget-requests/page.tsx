...
export default function BudgetRequestsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "สำเร็จ!",
        description: "ส่งคำขอของบประมาณเรียบร้อยแล้ว",
      });
  ...
  const handleReview = async (id: string, action: "approve" | "reject") => {
    try {
      ...
      toast({
        title: "สำเร็จ!",
        description: `${action === "approve" ? "อนุมัติ" : "ปฏิเสธ"}คำขอเรียบร้อยแล้ว`,
      });
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">คำขอเพิ่มงบประมาณ</p>
        </div>
        ...
        <Card className="bg-slate-800 border-slate-700 animate-fade-in">
          <CardHeader>
            ...
            <CardDescription className="text-slate-400">
              รายการคำขอเพิ่มงบประมาณทั้งหมด
            </CardDescription>
          </CardHeader>
          <CardContent>
            {requests.length === 0 ? (
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-slate-300">เหตุผล</TableHead>
